...
Citizen.CreateThread(function()
	...
	Citizen.CreateThread(function()
		while true do
			...
			if IsControlPressed(0, Keys['N7']) and IsInputDisabled(0) and (GetGameTimer() - GUI.Time) > 150 then
				SendNUIMessage({
					action  = 'controlPressed',
					control = 'LEFTMORE'
				})
			...
			if IsControlPressed(0, Keys['N9']) and IsInputDisabled(0) and (GetGameTimer() - GUI.Time) > 150 then
				SendNUIMessage({
					action  = 'controlPressed',
					control = 'RIGHTMORE'
				})
